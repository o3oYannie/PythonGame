...
# 공 크기에 따른 최초 스피드
ball_speed_y = [-18,-15,-12,-9] # 인덱스 0,1,2,3 해당하는 값
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        break # 안쪽 for 문에서 break를 만나면 여기로 진입 가능, 2중 for 문을 한 번에 탈출
